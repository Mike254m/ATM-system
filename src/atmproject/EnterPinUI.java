 ...
 * @author Faraday
 */
public class EnterPinUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your pin below");
        ...
        okBtn.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        okBtn.setText("OK");
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okBtnActionPerformed
        DashboardEN das = new DashboardEN();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterPinUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnterPinUI().setVisible(true);
            }
        });
    }
