 ...
 * @author Faraday
 */
public class BadilishaNambariUI extends javax.swing.JFrame {

    String display = "";
    
    public BadilishaNambariUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Weka nambari mpya ya siri");
    ...
    private void changeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeBtnActionPerformed
        ...
        try{
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Nambari ya siri imebadilishwa kwa mafanikio.\n Tumia nambari yako ya siri kufikia akaunti yako katika siku zijazo!");
            dispose();
            dash.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BadilishaNambariUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BadilishaNambariUI().setVisible(true);
            }
        });
    }
