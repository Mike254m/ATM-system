 ...
 * @author Faraday
 */
public class KutoaUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Weka utakayotoa");
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(wamount > 0 && wamount < 50){
                    JOptionPane.showMessageDialog(null, "Huwezi toa kiasi chini ya 50");
                }if(newBal<0){
                    JOptionPane.showMessageDialog(null, "Samahani!Huna fedha za kutosha kukamilisha ombi lako!");
                }else{
                    String sql2 = "UPDATE customer_id SET bankbalance = '"+Integer.toString(newBal)+"' WHERE customeID = '"+Welcome.loginID+"'";
                    pst.execute(sql2);
                    JOptionPane.showMessageDialog(null, "Uondoaji yako ya "+wamount+" ni mafanikio!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KutoaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
