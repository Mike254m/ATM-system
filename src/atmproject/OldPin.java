 ...
 * @author Faraday
 */
public class OldPin extends javax.swing.JFrame {
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    if(pin==temp){
                        ...
                        JOptionPane.showMessageDialog(null, "Incorrect!Please enter your current pin!");
                        oldpinField.setText("");
                    }
                }
            }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OldPin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
