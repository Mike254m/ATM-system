 ...
 * @author Faraday
 */
public class NambariKongwe extends javax.swing.JFrame {

    String display = "";
    
    public NambariKongwe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your old pin");
        ...
        oldpinField.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        oldpinField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        oldpinField.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                oldpinFieldMouseClicked(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(oldpinField, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void zeroBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zeroBtnActionPerformed
        // TODO add your handling code here:
        display = oldpinField.getText();
        oldpinField.setText(display + "0");
    }//GEN-LAST:event_zeroBtnActionPerformed

    private void oldpinFieldMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_oldpinFieldMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_oldpinFieldMouseClicked

    private void oneBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_oneBtnActionPerformed
        // TODO add your handling code here:
        display = oldpinField.getText();
        oldpinField.setText(display + "1");
    ...
    private void nineBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nineBtnActionPerformed
        // TODO add your handling code here:
        display = oldpinField.getText();
        oldpinField.setText(display + "9");
    }//GEN-LAST:event_nineBtnActionPerformed

    private void changeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeBtnActionPerformed
        // TODO add your handling code here:
        BadilishaNambariUI bad = new BadilishaNambariUI();
        int temp = Integer.parseInt(oldpinField.getText());
        try{
            ...
            if(rs.next()){
                ...
                if(pin==temp){
                    ...
                    JOptionPane.showMessageDialog(null, "Nambari uliyoweka sio sahihi. Tafadhali jaribu tena!");
                    oldpinField.setText("");
                }
            }
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NambariKongwe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NambariKongwe().setVisible(true);
            }
        });
    }
