 ...
 * @author Faraday
 */
public class WekaPesaUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kiasi cha kuweka");
        ...
        depositBtn.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        depositBtn.setText("Weka");
        ...
        backBtn.setFont(new java.awt.Font("Calibri", 1, 36)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(damountField, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {backBtn, damountField, depositBtn});
    ...
    private void depositBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositBtnActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                if(newBal<=0){
                    JOptionPane.showMessageDialog(null, "Tafadhali amana kiasi halali!");
                }else{
                    String sql2 = "UPDATE customer_id SET bankbalance = '"+Integer.toString(newBal)+"' WHERE customeID = '"+Welcome.loginID+"'";
                    pst.execute(sql2);
                    JOptionPane.showMessageDialog(null, "Amana yako ya "+damount+" imefanikiwa!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WekaPesaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WekaPesaUI().setVisible(true);
            }
        });
    }
